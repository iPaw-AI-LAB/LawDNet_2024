...
---
# 数据集筛选，对齐，提取landmark
**[数据集筛选，对齐，提取landmark](https://github.com/iPaw-AI-LAB/syncnet)代码** ，基于 [syncnet-python](https://github.com/joonson/syncnet_python) 重构
...
## 训练数据集准备
将数据集进行预处理，并正脸化, 请确保已经准备好视频数据和landmark。

#### 数据处理脚本

1. 用[数据集筛选，对齐，提取landmark](https://github.com/iPaw-AI-LAB/syncnet)代码处理视频 
...
4. 运行`data_processing_正脸化.py`, 进行训练数据集准备
...
为了让功能相同的选项排列在一起且易于识别，可以使用嵌套列表的方式：
...
如果您的此轮训练断了，希望从之前的训练断点继续训练，您可以设置如下：
