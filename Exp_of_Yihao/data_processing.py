...
def crop_face_by_landmark(source_img, land_mark):

    # 

    crop_face_data = source_img[
                    land_mark[29, 1] - radius_clip:frame_landmark[
...
def crop_face_according_openfaceLM(openface_landmark_dir,video_frame_dir,res_crop_face_dir,clip_length):
    ...
    for landmark_openface_path in landmark_openface_path_list:
        ...
        landmark_openface_data = load_landmark_openface(landmark_openface_path).astype(np.int64)
